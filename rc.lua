...
-- Taglist numerals
taglist_numbers_langs = { 'arabic', 'houssem', 'chinese', 'east_arabic', 'persian_arabic', }
taglist_numbers_sets = {
	arabic={ 1, 2, 3, 4, 5, 6, 7, 8, 9 },
	houssem={ '1:File', '2:Net', '3:Dev', '4:Chat', '5:Vir', '6:Img', '7:Med', '8:Sys', '9:Doc'},
...
for s = 1, screen.count() do
	...
	if taglist_numbers == 'random' then
		...
		tags[s] = awful.tag(taglist, s, layouts[4])
	else
		tags[s] = awful.tag(taglist_numbers_sets[taglist_numbers], s, layouts[4])
	end
...
awful.rules.rules = {
    ...
    { rule = { class = "lyx"             },   properties = { tag = tags[1][3] } },
    { rule = { class = "kile"            },   properties = { tag = tags[1][3] } },
    { rule = { class = "Texmaker"        },   properties = { tag = tags[1][3] } },
    { rule = { class = "Eclipse"         },   properties = { tag = tags[1][3] } },
    { rule = { class = "org.netbeans.core.windows.view.ui.MainWindow" },     properties = { tag = tags[1][3] } },
    { rule = { class = "Meld"            },   properties = { tag = tags[1][3] } },
    ...
    { rule = { class = "vmware"          },   properties = { tag = tags[1][5] } },
    { rule = { class = "vmplayer"        },   properties = { tag = tags[1][5] } },
    { rule = { class = "gqview"          },   properties = { tag = tags[1][6] } },
    { rule = { class = "mirage"          },   properties = { tag = tags[1][6] } },
    { rule = { class = "gimp"            },   properties = { tag = tags[1][6] } },
    { rule = { class = "kaffeine"        },   properties = { tag = tags[1][7] } },
    { rule = { class = "Audacious"       },   properties = { tag = tags[1][7] } },
    { rule = { class = "MPlayer"         },   properties = { tag = tags[1][7] } },
    { rule = { class = "VLC"             },   properties = { tag = tags[1][7] } },
    { rule = { class = "realplay.bin"    },   properties = { tag = tags[1][7] } },
    { rule = { class = "Synaptic"        },   properties = { tag = tags[1][8] } },
    { rule = { class = "grsync"          },   properties = { tag = tags[1][8] } },
    { rule = { class = "Firestarter"     },   properties = { tag = tags[1][8] } },
    { rule = { class = "okular"          },   properties = { tag = tags[1][9] } },
    { rule = { class = "acroread"        },   properties = { tag = tags[1][9] } },
    { rule = { class = "Evince"          },   properties = { tag = tags[1][9] } },
    { rule = { class = "Fbreader"        },   properties = { tag = tags[1][9] } },
    { rule = { class = "basket"          },   properties = { tag = tags[1][9] } },
}
-- }}}
